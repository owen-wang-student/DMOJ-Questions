...
def left(turn, row, column, board):
    if column - 1 > 0:
        if turn == 1:
            if board[row][column - 1] == "W":
                board[row][column - 1] = "B"
...
def down(turn, row, column, board):
    if row - 1 > 0:
        if turn == 1:
            if board[row+-1][column] == "W":
                board[row-1][column] = "B"
    ...
    if row + 1 < 9 and column + 1 < 9:
        if turn == 1:
            if board[row + 1][column + 1] == "W":
                ...
                right(turn, row + 1, column + 1, board)
            else:
                return False
        if turn == 2:
            if board[row + 1][column + 1] == "B":
...
# up left - -
def dia2(turn, row, column, board):
    if row - 1 > 0 and column - 1 > 0:
        if turn == 1:
            if board[row - 1][column - 1] == "W":
                board[row - 1][column - 1] = "B"
...
# down left + -
def dia4(turn, row, column, board):
    if row + 1 < 9 and column - 1 > 0:
        if turn == 1:
            if board[row + 1][column - 1] == "W":
                board[row + 1][column - 1] = "B"
